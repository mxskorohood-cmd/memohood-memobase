...
- 🖥️ **Облако или полностью локально — на выбор** — по умолчанию эмбеддинги считает бесплатный тариф Cloudflare; либо на этапе установки ставишь локальную модель ONNX (`fastembed`, без PyTorch, без ключа) — и для поиска наружу не уходит ничего. Мастер спросит, что выбрать. [Как →](#ключи-api)
